...
export interface Archetype {
  ...
  moodPhoto: string
  accent: string      // hex color for archetype personality
  accentLight: string // lighter variant for badges
  duotone: string     // gradient CSS for card overlay
}
...
export const ARCHETYPES: Record<ArchetypeId, Archetype> = {
  inner_circle: {
    ...
    accent: '#F59E0B',
    accentLight: '#FCD34D',
    duotone: 'linear-gradient(135deg, #F59E0B 0%, #92400E 100%)',
  },
  operators: {
    id: 'operators',
    name: 'OPERATORS',
    ...
    accent: '#3B82F6',
    accentLight: '#93C5FD',
    duotone: 'linear-gradient(135deg, #3B82F6 0%, #1E3A5F 100%)',
  },
  insurgents: {
    id: 'insurgents',
    name: 'INSURGENTS',
    ...
    accent: '#EF4444',
    accentLight: '#FCA5A5',
    duotone: 'linear-gradient(135deg, #EF4444 0%, #7F1D1D 100%)',
  },
  climbers: {
    id: 'climbers',
    name: 'CLIMBERS',
    ...
    accent: '#10B981',
    accentLight: '#6EE7B7',
    duotone: 'linear-gradient(135deg, #10B981 0%, #064E3B 100%)',
  },
  intelligentsia: {
    id: 'intelligentsia',
    name: 'INTELLIGENTSIA',
    ...
    accent: '#8B5CF6',
    accentLight: '#C4B5FD',
    duotone: 'linear-gradient(135deg, #8B5CF6 0%, #3B0764 100%)',
  },
  builders: {
    id: 'builders',
    name: 'BUILDERS',
    ...
    accent: '#06B6D4',
    accentLight: '#67E8F9',
    duotone: 'linear-gradient(135deg, #06B6D4 0%, #164E63 100%)',
  },
}
